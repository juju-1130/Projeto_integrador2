...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section bg-primary text-white mb-0" id="title">
            <div class="container">
                <h5 class="page-section-heading text-uppercase text-white">Seja Bem Vindo à <br> MK Energia Solar</h5>
            </div>
        </section>
        <!-- Masthead-->
        <header>
        ...
        <section class="page-section projects" id="projects">
            <div class="container">
                ...
                <div id="projeto-destacado-container"></div>
                <!-- Primeiro Projeto -->
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const container = document.getElementById('projeto-destacado-container');
            container.innerHTML = '';
            ...
            projetos.forEach(projeto => {
                const projetoHTML = `
                    <div class="project-card mb-5 p-4 rounded-3 bg-light">
                        <div class="row align-items-center g-4">
                            <div class="col-lg-5 col-md-6">
                                <img src="${projeto.imagem}" class="img-fluid rounded shadow projeto-img" alt="${projeto.titulo}">
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="ps-lg-4">
                                    <h3 class="project-title mb-3">${projeto.titulo}</h3>
                                    <ul class="project-features list-unstyled">${projeto.detalhes}</ul>
                                    <div class="project-meta mt-3 small text-muted">${projeto.meta}</div>
                                    <div class="mt-3">${projeto.tags.join(' ')}</div>
                                </div>
                            </div>
                        </div>
                    </div>
