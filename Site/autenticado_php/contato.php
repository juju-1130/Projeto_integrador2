            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1 w-100 w-lg-auto"><a class="nav-link py-3 px-0 px-lg-3 rounded bg-primary " href="contato.html">Fale Conosco</a></li>
                        <li class="nav-item mx-0 mx-lg-1 w-100 w-lg-auto"><a class="nav-link py-3 px-0 px-lg-3 rounded text-primary" href="orcamento.html">Orçamento</a></li>
