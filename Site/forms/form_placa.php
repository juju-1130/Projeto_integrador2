      ...
      <table class="table table-striped">
        ...
        <tbody>
          <tr>
            ...
            <td>R$ 700,00</td>
            <td>
              <a href="editar_item.php?tipo=placa&id=1" class="btn btn-warning btn-sm">Editar</a>
              <a href="excluir_item.php?tipo=placa&id=1" class="btn btn-danger btn-sm">Excluir</a>
            </td>
          </tr>
          <tr>
            <td>Sunova Solar</td>
            ...
            <td>R$ 770,00</td>
            <td>
              <a href="editar_item.php?tipo=placa&id=2" class="btn btn-warning btn-sm">Editar</a>
              <a href="excluir_item.php?tipo=placa&id=2" class="btn btn-danger btn-sm">Excluir</a>
            </td>
          </tr>
        </tbody>
      </table>
