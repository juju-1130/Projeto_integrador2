...
<head>
    <meta charset="utf-8">
    <title>Orçamento #<?= $orcamento_id ?><?= !isset($gerando_pdf) ? ' — ' . htmlspecialchars($orcamento['nome_usuario'] ?? '') : '' ?></title>
    
    <?php if(!isset($gerando_pdf)): ?>
    ...
    <style>
        * { 
        ...
        th { background: #007bff !important; color: white !important; font-weight: 600; }
        ...
        .payment-card.highlight { border-color: #28a745; background: #f8fff9 !important; }
        ...
        .btn-download { background: #28a745; color: white; padding: 12px 24px; border: none; border-radius: 6px; cursor: pointer; font-size: 16px; text-decoration: none; display: inline-block; margin: 0 10px; }
        .page-break { page-break-after: always; }
        
        /* Ícones profissionais - FALLBACK PARA PDF */
        ...
        @media print {
            ...
            /* ESCONDER FONT AWESOME E MOSTRAR FALLBACK */
            .fas, .fa, .fab, .far {
                display: none !important;
            }
            .icon-fallback {
        ...
        /* ESTILOS PARA QUANDO ESTÁ GERANDO PDF */
        <?php if(isset($gerando_pdf)): ?>
        body {
        ...
        /* Substituições de ícones para PDF */
        .fa-rocket::before,
        [class*="fa-rocket"] .icon-fallback::before { content: "🚀"; }
        
        .fa-drafting-compass::before,
        [class*="fa-drafting-compass"] .icon-fallback::before { content: "📐"; }
        
        .fa-truck::before,
        [class*="fa-truck"] .icon-fallback::before { content: "🚚"; }
        
        .fa-tools::before,
        [class*="fa-tools"] .icon-fallback::before { content: "🛠"; }
        
        .fa-file-contract::before,
        [class*="fa-file-contract"] .icon-fallback::before { content: "📋"; }
        
        .fa-chart-line::before,
        [class*="fa-chart-line"] .icon-fallback::before { content: "📊"; }
        
        .fa-cogs::before,
        [class*="fa-cogs"] .icon-fallback::before { content: "⚙"; }
        
        .fa-bolt::before,
        [class*="fa-bolt"] .icon-fallback::before { content: "⚡"; }
        
        .fa-sun::before,
        [class*="fa-sun"] .icon-fallback::before { content: "☀"; }
        
        .fa-solar-panel::before,
        [class*="fa-solar-panel"] .icon-fallback::before { content: "☀"; }
        
        .fa-plug::before,
        [class*="fa-plug"] .icon-fallback::before { content: "🔌"; }
        
        .fa-balance-scale::before,
        [class*="fa-balance-scale"] .icon-fallback::before { content: "⚖"; }
        
        .fa-home::before,
        [class*="fa-home"] .icon-fallback::before { content: "🏠"; }
        
        .fa-money-bill-wave::before,
        [class*="fa-money-bill-wave"] .icon-fallback::before { content: "💰"; }
        
        .fa-leaf::before,
        [class*="fa-leaf"] .icon-fallback::before { content: "🌿"; }
        
        .fa-tree::before,
        [class*="fa-tree"] .icon-fallback::before { content: "🌳"; }
        
        .fa-car::before,
        [class*="fa-car"] .icon-fallback::before { content: "🚗"; }
        
        .fa-globe-americas::before,
        [class*="fa-globe-americas"] .icon-fallback::before { content: "🌎"; }
        
        .fa-star::before,
        [class*="fa-star"] .icon-fallback::before { content: "★"; }
        
        .fa-bullseye::before,
        [class*="fa-bullseye"] .icon-fallback::before { content: "🎯"; }
        
        .fa-award::before,
        [class*="fa-award"] .icon-fallback::before { content: "🏆"; }
        
        .fa-headset::before,
        [class*="fa-headset"] .icon-fallback::before { content: "📞"; }
        
        .fa-phone::before,
        [class*="fa-phone"] .icon-fallback::before { content: "📞"; }
        
        .fa-envelope::before,
        [class*="fa-envelope"] .icon-fallback::before { content: "✉"; }
        
        .fa-chart-bar::before,
        [class*="fa-chart-bar"] .icon-fallback::before { content: "📊"; }
        
        .fa-shield-alt::before,
        [class*="fa-shield-alt"] .icon-fallback::before { content: "🛡"; }
        <?php endif; ?>
    </style>
</head>
<body>
    ...
    <div class="button-container no-print">
        <a href="gerar_pdf.php?id=<?= $orcamento_id ?>&pdf=true" class="btn-download">
            <i class="fas fa-download"></i> Baixar PDF
        </a>
        <button onclick="window.print()" class="btn-print">
            <i class="fas fa-print"></i> Imprimir
        </button>
        <button onclick="window.history.back()" class="btn-print" style="background: #6c757d;">
    ...
    <div class="cover-page">
        ...
        <div style="margin-top: 40px; font-size: 16px;">
            <i class="fas fa-phone"></i><span class="icon-fallback">📞</span> (51) 3547-1530 • (51) 99562-2598<br>
            <i class="fas fa-envelope"></i><span class="icon-fallback">✉</span> mkferragenseeletrica@gmail.com
        </div>
    </div>
    ...
    <div class="page">
        <h1><i class="fas fa-rocket"></i><span class="icon-fallback">🚀</span> Fases do Projeto</h1>
        
        <div class="fases-grid">
            <div class="fase-card">
                <div class="fase-icon"><i class="fas fa-drafting-compass"></i><span class="icon-fallback">📐</span></div>
                <h3>Projeto</h3>
                <p>Seu projeto será desenvolvido por nosso time de engenheiros e atenderá todas as exigências normativas.</p>
            </div>
            
            <div class="fase-card">
                <div class="fase-icon"><i class="fas fa-truck"></i><span class="icon-fallback">🚚</span></div>
                <h3>Logística</h3>
                <p>Cuidaremos para que seu equipamento seja entregue com segurança no local da instalação.</p>
            </div>
            
            <div class="fase-card">
                <div class="fase-icon"><i class="fas fa-tools"></i><span class="icon-fallback">🛠</span></div>
                <h3>Instalação</h3>
                <p>Agendaremos a instalação para um momento conveniente a sua rotina.</p>
            </div>
            
            <div class="fase-card">
                <div class="fase-icon"><i class="fas fa-file-contract"></i><span class="icon-fallback">📋</span></div>
                <h3>Homologação</h3>
                <p>Cuidaremos de toda a papelada da homologação do seu sistema junto a concessionária.</p>
            </div>
            
            <div class="fase-card">
                <div class="fase-icon"><i class="fas fa-chart-line"></i><span class="icon-fallback">📊</span></div>
                <h3>Monitoramento</h3>
                <p>Acompanhamos a geração de energia do seu sistema frequentemente para identificar possíveis falhas.</p>
            </div>
            
            <div class="fase-card">
                <div class="fase-icon"><i class="fas fa-cogs"></i><span class="icon-fallback">⚙</span></div>
                <h3>Manutenção</h3>
